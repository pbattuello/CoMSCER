...
ggarrange(cos_sim_matrix1_C2_plot, cos_sim_matrix2_C2_plot,
	  labels = c("A", "B"),
	  ncol = 2, nrow = 1,
...
ggarrange(cos_sim_matrix1_C3_2_plot, cos_sim_matrix2_C3_2_plot,
          labels = c("A", "B"),
          ncol = 2, nrow = 1,
          font.label = list(size = 10, color = "black", face = "bold"))
...
ggarrange(SBS_C2_plot, SBS_C3_2_plot,
          labels = c("A", "B"),
          ncol = 1, nrow = 2,
          font.label = list(size = 10, color = "black", face = "bold"))


ggsave(paste(working_dir, "Figures", "SBS_contribution.png", sep="/"), dpi=300)
